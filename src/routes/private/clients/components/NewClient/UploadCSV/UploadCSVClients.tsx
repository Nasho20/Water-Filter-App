...
import styles from "./UploadCSVClient.module.scss";
import { CloudUpload } from "../../../../../../assets";

interface UploadCSVClientsProps {
  onFileUpload: (data: string[][]) => void;
}

const UploadCSVClients: React.FC<UploadCSVClientsProps> = ({
  onFileUpload,
}) => {
...
export default UploadCSVClients;
